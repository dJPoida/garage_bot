 ...
 */
export const sizeKB = (bytes: number): string =>
  commas(Math.floor(bytes * 0.001));
 ...
 */
export const sizeMB = (bytes: number): string =>
  commas(Math.floor(bytes * 0.000001));
 ...
 */
export const sizeGB = (bytes: number): string =>
  commas(Math.floor(bytes * 0.000000001));
 ...
 */
export const sizeBits = (bytes: number): string =>
  commas(Math.floor(bytes * 8));
